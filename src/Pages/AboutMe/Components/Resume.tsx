    ...
    return (
        <div className="cv-experience-item mb-4">
            <div className="d-flex justify-content-between align-items-start mb-1">
                <h4 className="h6 fw-bold text-dark mb-1">{ role }</h4>
                <span className="cv-period badge bg-light text-muted fw-normal">{ period }</span>
            </div>
            <div className="text-primary fw-medium mb-2">@{ company }</div>
    ...
    return (
        <div className="cv-education-item mb-4">
            <div className="d-flex justify-content-between align-items-baseline mb-1">
                <h4 className="h6 fw-bold mb-0">{ title }</h4>
...
const Sidebar = (
    { fullName, children }:
    WithChildren<{ fullName: string }> ) => {
    return (
        <aside className="col-lg-4 cv-sidebar p-4 text-white">
            <div className="text-center mb-5 mt-3">
                <h2 className="h3 fw-bold mb-1">{ fullName }</h2>
            </div>
        ...
        <div className="cv-container py-5">
            <main className="cv-page shadow-lg mx-auto bg-white">
                <div className="row g-0 h-100">
                    ...
                    <Sidebar fullName={ personalData.fullName }>
                        <SideBarSection title="Contact">
                            <ul className="list-unstyled cv-contact-list small">
                                <li className="mb-2"><i className="fa-solid fa-phone me-2"></i>
                                    <span>
                                        <a href={`tel:${personalData.phone}`} className="text-decoration-none text-reset cv-link">
                                            { personalData.phone }
                                        </a>
                                    </span>
                                </li>
                    ...
                    <div className="col-lg-8 p-4">
                        <header className="mb-5 border-bottom pb-4">
                            ...
                            <p className="text-primary fst-italic mb-0 cv-header-quote">
                                "{ personalData.quote }"
                            </p>
                        </header>
